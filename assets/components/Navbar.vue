<template>
  <div>
    <b-navbar toggleable="lg" type="dark" variant="info">
      <b-navbar-brand :to="{ name: 'home' }">Club Employés</b-navbar-brand>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          <b-nav-item v-if="!isAuthenticated" :to="{ name: 'register' }"
            >Register</b-nav-item
          >
          <b-nav-item v-if="isAuthenticated" :to="{ name: 'dashboard' }"
            >Dashboard</b-nav-item
          >
          <b-nav-item v-if="isAuthenticated" :to="{ name: 'friends' }"
          >Friends</b-nav-item
          >
